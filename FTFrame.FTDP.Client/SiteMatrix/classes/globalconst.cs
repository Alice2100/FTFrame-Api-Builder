...
using FTDPClient.Resource;
using System.Collections;
using System.Data.OleDb;
using Microsoft.Data.Sqlite;

namespace FTDPClient.consts
{
	/// <summary>
	/// globalconst 的摘要说明。
	/// </summary>
	...
	public class globalConst
	{
        ...
        //SimpleMode 
        public static bool SimpleMode = true;
        public static string Key = functions.file.getFileText(Application.StartupPath + @"\update\user", System.Text.Encoding.UTF8);
        public struct CurSite
        {
            ...
            public static bool CodeSetChanged = false;
            public static string SiteTreeRootCaption => ID + " [" + Domain + "]";
		//add others here
		}
        public enum DBType
        {
	...
	public class res
	{
	    public static rm MainForm=new rm("FTDPClient.resource.mainform");
        public static rm ToolBox = new rm("FTDPClient.resource.toolbox");
        public static rm Space = new rm("FTDPClient.resource.workspace");
        public static rm MainBox = new rm("FTDPClient.resource.mainbox");
        public static rm Editor = new rm("FTDPClient.resource.editor");
        public static rm TemplateManage = new rm("FTDPClient.resource.templatemanage");
        public static rm TagEdit = new rm("FTDPClient.resource.tagedit");
        public static rm StyleBuilder = new rm("FTDPClient.resource.stylebuilder");
        public static rm Snippet = new rm("FTDPClient.resource.snippet");
        public static rm SiteUpdate = new rm("FTDPClient.resource.siteupdate");
        public static rm SiteReport = new rm("FTDPClient.resource.sitereport");
        public static rm SitePublish = new rm("FTDPClient.resource.sitepublish");
        public static rm SiteList = new rm("FTDPClient.resource.sitelist");
        public static rm SiteImport = new rm("FTDPClient.resource.siteimport");
        public static rm SiteExport = new rm("FTDPClient.resource.siteexport");
        public static rm SiteClear = new rm("FTDPClient.resource.siteclear");
        public static rm SiteAdd = new rm("FTDPClient.resource.siteadd");
        public static rm PartImage = new rm("FTDPClient.resource.partimage");
        public static rm Option = new rm("FTDPClient.resource.option");
        public static rm OpenWebPage = new rm("FTDPClient.resource.openwebpage");
        public static rm ModifyDNS = new rm("FTDPClient.resource.modifydns");
        public static rm LoadStat = new rm("FTDPClient.resource.loadstat");
        public static rm Loading = new rm("FTDPClient.resource.loading");
        public static rm InputName = new rm("FTDPClient.resource.inputname");
        public static rm ImportPage = new rm("FTDPClient.resource.importpage");
        public static rm GetNode = new rm("FTDPClient.resource.getnode");
        public static rm FindReplace = new rm("FTDPClient.resource.findreplace");
        public static rm ErrorReport = new rm("FTDPClient.resource.errorreport");
        public static rm AddSite = new rm("FTDPClient.resource.addsite");
        public static rm AddPage = new rm("FTDPClient.resource.addpage");
        public static rm AddDir = new rm("FTDPClient.resource.adddir");
        public static rm AddControl = new rm("FTDPClient.resource.addcontrol");
        public static rm About = new rm("FTDPClient.resource.about");
        public static rm _controls = new rm("FTDPClient.resource._controls");
        public static rm _globalconst = new rm("FTDPClient.resource._globalconst");
        public static rm _globalfunctions = new rm("FTDPClient.resource._globalfunctions");
        public static rm _pageware = new rm("FTDPClient.resource._pageware");
        public static rm _propertysite = new rm("FTDPClient.resource._propertysite");
        public static rm _site = new rm("FTDPClient.resource._site");
        public static rm form = new rm("FTDPClient.resource.form");
        public static rm com = new rm("FTDPClient.resource.com");
        public static rm ctl = new rm("FTDPClient.resource.ctl");
        public static rm anew = new rm("FTDPClient.resource._anew");
        public static rm front = new rm("FTDPClient.resource.front");
        public static rm ft = new rm("FTDPClient.resource.ft");
        public static rm ftform = new rm("FTDPClient.resource.ftform");
        public static rm ftclass = new rm("FTDPClient.resource.ftclass");
        public static rm @class = new rm("FTDPClient.resource.class");
    }
