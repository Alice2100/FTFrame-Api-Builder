...
namespace FTDPClient.Adapter
{
    ...
    {
        public static string NotSet = FTDPClient.consts.res._pageware.GetString("NotSet");
        [System.ComponentModel.LicenseProviderAttribute(typeof(FTDPClient.classes.LicenceProvider))]
        ...
        public class TabelElement
        {
           ...
           TypeConverterAttribute(typeof(SourceEditorConverter)),
            ...
            [DescriptionAttribute("使用LeyUI框架时，定义lay-filter"), CategoryAttribute("其他")]
            public string layFilter
            {
                get
                {
                    return PropertyAdapter.getEleAttr(e, "lay-filter");
                }
                set
                {
                    PropertyAdapter.setEleAttr(e, "lay-filter", value);
                }
            }
            [DescriptionAttribute("Retrieves the string identifying the object."),
            CategoryAttribute("Misc")]
