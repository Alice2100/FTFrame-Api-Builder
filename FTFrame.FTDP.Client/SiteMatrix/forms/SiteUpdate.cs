...
namespace FTDPClient.forms
{
	...
	public class SiteUpdate : System.Windows.Forms.Form
	{
		...
		try
		{
            ...
            string changeurl = _url + "/_ftpub/hidden2zip?_id=" + _id + "&_key=" + _key + "&_user=" + _user + "&_passwd=" + _passwd;
            ...
            changeurl = _url + "/_ftpub/zip2hidden?_id=" + _id + "&_key=" + _key + "&_user=" + _user + "&_passwd=" + _passwd;
