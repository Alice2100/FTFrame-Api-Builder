...
namespace FTDPClient.forms
{
	...
	/// </summary>
	/// 
	[LicenseProviderAttribute(typeof(FTDPClient.classes.LicenceProvider))]
	public class Workspace : System.Windows.Forms.Form
	{
		...
		private void menuItem7_Click(object sender, System.EventArgs e)
		{
			...
			TreeNode rootnode;
			rootnode=new TreeNode(globalConst.CurSite.SiteTreeRootCaption,0,1);
		...
		private void siteTree_MouseDown(object sender, MouseEventArgs e)
		{
			...
			if(nd!=null)
			{
				...
				if(tree.getTypeFromID(tree.getID(nd)).Equals("root"))
				{
					...
					globalConst.PropForm.propertyGrid1.SelectedObject=FTDPClient.PropertySpace.Site.PropertySite.Bag();
					return;
				}
				if(tree.getTypeFromID(tree.getID(nd)).Equals("drct"))
				{
					...
					globalConst.PropForm.propertyGrid1.SelectedObject=FTDPClient.PropertySpace.Site.PropertyDirectory.Bag();
					return;
				}
				if(tree.getTypeFromID(tree.getID(nd)).Equals("page"))
				{
					...
					globalConst.PropForm.propertyGrid1.SelectedObject=FTDPClient.PropertySpace.Site.PropertyPage.Bag();
					return;
				}
