...
namespace FTDPClient.forms
{
    public partial class PA_Div : Form
    {
        ...
        {
            RcheckBox1.Text = res.ctl.str("PA_Div.RcheckBox1");         //ID、Name替换
            checkBox1.Text = res.ctl.str("PA_Div.checkBox1");			//从[DIV]模板导入
        ...
        private void Button2_Click_1(object sender, EventArgs e)
        {
            ...
            if(newid=="")
            {
                MsgBox.Warning(res.ctl.str("PA_Div.1"));
                return;
            }
            ...
            if(checkBox1.Checked)
            {
                ...
                {
                    MsgBox.Warning(res.ctl.str("PA_Div.2"));
                    return;
                }
            ...
            if(IsAddNew)
            {
                ...
                if (oEle != null)
                {
                    MsgBox.Warning(res.ctl.str("PA_Div.3").Replace("{0}",newid));
                    return;
                }
                string newhtml = "";
                ...
                {
                    divHTML += res.ctl.str("PA_Div.4");
                }
                divHTML += "</div>";
                string headHTML = "<SPAN id="+ newid + "_ftheader style=' display: none'>Head Start：【<FONT id=" + newid + "_ftheader1 color=blue>"+ name + "</FONT>&nbsp;&nbsp;&nbsp;&nbsp;<FONT id=" + newid + "_ftheader2 color=red>ID:&nbsp;" + newid + "</FONT>&nbsp;&nbsp;&nbsp;&nbsp;Added：" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss")+"】Head End</SPAN>";
            ...
            if (content != null)
            {
                ...
                else
                {
                    ...
                    string head = "<SPAN  id=" + newid + "_ftheader  style='display: none'>Head Start：【<FONT color=blue id=" + newid + "_ftheader1>" + name + "</FONT>&nbsp;&nbsp;&nbsp;&nbsp;<FONT color=red id=" + newid + "_ftheader2>ID:&nbsp;" + newid + "</FONT>&nbsp;&nbsp;&nbsp;&nbsp;Added：" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + "】Head End</span>";
