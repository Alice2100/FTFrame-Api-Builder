...
namespace FTDPClient.forms
{
    public partial class PageAssis : Form
    {
        ...
        private void PageAssis_Load(object sender, EventArgs e)
        {
            ...
            #region Language
            textBox1.Text = res.form.GetString("shuruid");
            button8.Text = res.form.GetString("dingwei");
            button1.Text = res.form.GetString("shuaxin");
            button2.Text = res.form.GetString("guanbi");
            #endregion
        }
        ...
        {
            if (textBox1.Text.Equals(res.form.GetString("shuruid"))) textBox1.Text = "";
        }
        ...
        public static void Analys()
        {
            ...
            foreach (IHTMLElement ele in eles)
            {
                if (ele.id != null && ele.id.ToLower().Equals("ftdpcom"))
                {
