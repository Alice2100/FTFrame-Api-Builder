...
{
    public class DyValue_Api : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            this.apidiaoyong = new System.Windows.Forms.Label();
            ...
            this.Close.Location = new System.Drawing.Point(807, 496);
            ...
            this.OK.Location = new System.Drawing.Point(694, 496);
            this.OK.Name = "OK";
            ...
            this.luyou.Size = new System.Drawing.Size(207, 26);
            ...
            this.miaosu.Location = new System.Drawing.Point(519, 9);
            this.miaosu.Name = "miaosu";
            this.miaosu.Size = new System.Drawing.Size(343, 26);
            ...
            this.pl.Name = "pl";
            this.pl.Size = new System.Drawing.Size(695, 420);
            this.pl.TabIndex = 51;
            // 
            // apidiaoyong
            // 
            this.apidiaoyong.AutoSize = true;
            this.apidiaoyong.ForeColor = System.Drawing.SystemColors.AppWorkspace;
            this.apidiaoyong.Location = new System.Drawing.Point(640, 45);
            this.apidiaoyong.Name = "apidiaoyong";
            this.apidiaoyong.Size = new System.Drawing.Size(47, 12);
            this.apidiaoyong.TabIndex = 52;
            this.apidiaoyong.Text = "Api调用";
            // 
            // SelAllCheck
            // 
            this.SelAllCheck.AutoSize = true;
            this.SelAllCheck.Font = new System.Drawing.Font("宋体", 10F);
            this.SelAllCheck.Location = new System.Drawing.Point(576, 502);
            this.SelAllCheck.Name = "SelAllCheck";
            this.SelAllCheck.Size = new System.Drawing.Size(54, 18);
            this.SelAllCheck.TabIndex = 53;
            ...
            this.Controls.Add(this.apidiaoyong);
        ...
        {
            string NewName = "GetInfo_" + (this.listView1.Items.Count + 1);
            string NewNameCap = "详情_" + (this.listView1.Items.Count + 1);
            ...
            string ApiDecs = "";
            string ApiLinks = "";
            foreach(string[] item in idCapList)
            {
                ApiNames += "[#]" + item[0];
                ApiIds += "[#]" + item[0];
                ApiDecs += "[#]" + item[1];
            ...
            if(idCapList.Count>0)
            {
                ApiNames = ApiNames.Substring(3); ApiIds = ApiIds.Substring(3); ApiDecs = ApiDecs.Substring(3); ApiLinks = ApiLinks.Substring(3);
            }

            al.Add(new string[] { NewName, NewNameCap, ApiNames, ApiIds, ApiDecs , ApiLinks });
        ...
        {
            this.Text = res.ctl.str("DyValueApi.text");         //数据获取 Api
            label2.Text = res.ctl.str("DyValueApi.label2");         //接口路由
            label1.Text = res.ctl.str("DyValueApi.label1");         //接口描述
            label9.Text = res.ctl.str("DyValueApi.label9");         //输出
            label10.Text = res.ctl.str("DyValueApi.label10");           //ID列
            label11.Text = res.ctl.str("DyValueApi.label11");           //说明
            apidiaoyong.Text = res.ctl.str("DyValueApi.apidiaoyong");			//Api调用
        ...
        private void setInitFromSetString(string setstr)
        {
            ...
            (item[0].Trim().Equals("")?"GetInfo_"+(this.listView1.Items.Count+1):(item[0].Trim()))}, -1, System.Drawing.Color.Empty, System.Drawing.SystemColors.Window, new System.Drawing.Font("宋体", 12F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(134))));
                listview.ImageIndex = 26;
                this.listView1.Items.Add(listview);
            }
        ...
        private void listView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            luyou.Visible = true;
            miaosu.Visible = true;
            apidiaoyong.Visible = true;

            string[] item = ((string[])al[listView1.SelectedItems[0].Index]);
            luyou.Text = item[0];
            miaosu.Text = item[1];
            TextBoxInit(item[2], item[3], item[4], item[5]);
        }
        List<Control[]> ctlList = new List<Control[]>();
       private void TextBoxInit(string ApiNames,string ApiIDs,string ApiDecs,string ApiLinks)
        {
            ...
            string[] ApiLinksItem = ApiLinks.Split(new string[] { "[#]" }, StringSplitOptions.None);
            for(int i=0;i< idCapList.Count;i++)
            {
                string ApiId = idCapList[i][0];
                string ApiDesc = idCapList[i][1];
                int index = -1;
                ...
                {
                    Font = new Font("宋体", 12F),
                    Size = new Size(221, 26),
                    Location = new Point(453, 0 + 36 * i),
                    Tag = i
                };
                ...
                textBox4.MouseDoubleClick += TextBox4_Click;
                if (index>=0)
                {
                    ckBox.Checked = true;
                    ...
                    textBox4.Text = ApiLinksItem[index];
                }
                else
                {
                    ckBox.Checked = false;
                ...
                pl.Controls.Add(ckBox); pl.Controls.Add(textBox1); pl.Controls.Add(label2); pl.Controls.Add(textBox3); pl.Controls.Add(textBox4);
                ctlList.Add(new Control[] { ckBox, textBox1, label2, textBox3, textBox4 });
        ...
        private void CkBox_Click(object sender, EventArgs e)
        {
            ...
            ctlList[index][4].Enabled = ((CheckBox)sender).Checked;
        ...
        string[] Set2Array()
        {
            ...
            foreach(Control[] ctrls in ctlList)
            {
                if(((CheckBox)ctrls[0]).Checked)
                {
                    ...
                    apiLinks += "[#]" + ((TextBox)ctrls[4]).Text.Trim();
                }
            }
            if (apiNames != "") apiNames = apiNames.Substring(3);
            if (apiIds != "") apiIds = apiIds.Substring(3);
            if (apiDecs != "") apiDecs = apiDecs.Substring(3);
            if (apiLinks != "") apiLinks = apiLinks.Substring(3);

            return new string[] { luyou.Text.Trim(),miaosu.Text.Trim(), apiNames, apiIds, apiDecs, apiLinks };
        }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            if (listView1.SelectedItems.Count == 1)
            {
                ...
                if (curpos > 0)
                {
                    ...
                    listView1.Items[curpos - 1].Text = (o1[0].Trim().Equals("") ? "GetInfo_" + curpos : (o1[0].Trim() )) ;
                    listView1.Items[curpos].Text = (o0[0].Trim().Equals("") ? "GetInfo_" + (curpos + 1) : (o0[0].Trim())) ;
                    listView1.SelectedItems.Clear();
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            if (listView1.SelectedItems.Count == 1)
            {
                ...
                if (curpos < al.Count-1)
                {
                    ...
                    listView1.Items[curpos + 1].ForeColor = c2;
                    listView1.Items[curpos].ForeColor = c1;
                    listView1.Items[curpos + 1].Text = (o1[0].Trim().Equals("") ? "GetInfo_" + (curpos + 2) : (o1[0].Trim() )) ;
                    listView1.Items[curpos].Text = (o0[0].Trim().Equals("") ? "GetInfo_" + (curpos + 1) : (o0[0].Trim() )) ;
                    listView1.SelectedItems.Clear();
                    listView1.Items[curpos + 1].Selected = true;
                    InitCfgStr();
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            ...
            {
                functions.MsgBox.Warning(res.ctl.str("DyValueApi.1"));
            }
            else
            {
