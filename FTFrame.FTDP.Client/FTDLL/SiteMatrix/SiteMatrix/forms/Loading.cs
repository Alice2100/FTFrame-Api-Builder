...
namespace SiteMatrix.forms
{
	...
	public class Loading : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            this.label1.Text = "SiteMatrix is loading,please wait...";
            // 
            // timer1
            // 
        ...
        private void ApplyLanguage()
        {
            ...
            label1.Text = "SiteMatrix is loading,please wait...";
        }
		...
		private void timer1_Tick(object sender, System.EventArgs e)
		{
			try
			{
                ...
                globalConst.ConfigConn.Open("Provider=" + globalConst. OLEDBProvider + ";Data Source=" + globalConst.ConfigFile);
				//Init Css Document
                ...
                System.IO.Directory.Delete(globalConst.FreeFilesPath, true);
			    ...
			    //copy resource files:
                //System.IO.DirectoryInfo di=new DirectoryInfo(@"D:\d4soft\bk\wang\work\SiteMatrix\SiteMatrix\resource");
