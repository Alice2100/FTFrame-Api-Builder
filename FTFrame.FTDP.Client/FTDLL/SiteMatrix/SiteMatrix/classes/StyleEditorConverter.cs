            ...
            if (context != null && context.Instance != null && provider != null)
            {
                ...
                if (service != null)
                {
                    ...
                    else
                    {
                        ...
                        if (!FormData.TheFormData.IsCancel)
                        {
                            return SiteMatrix.PropertySpace.FormElementData.func.getFormDataBindStr(FormData.ele);
                        }
                    }
...
//		}
	...
	{  
			...
			GetStandardValues(ITypeDescriptorContext context) 
		{
            ...
            System.Data.OleDb.OleDbDataReader dr = globalConst.CurSite.SiteConn2.OpenRecord(sql);
