...
namespace SiteMatrix.PropertySpace.FormElementData
{
    ...
    public class func
    {
        ...
        public static string getFormDataBindStr(IHTMLElement ele)
        {
            string para = ele.getAttribute("tag", 0) == null ? null : ele.getAttribute("tag", 0).ToString();
            if (para.Equals("")) return "Warning:(Not Set)";
            if (globalConst.CurSite.FormDataXML==null) return "Warning:(Set XML Deleted)";
            try
            {
                para = str.GetSplitValue(para, 0);
            }
            catch {
                return "Error:Wrong tag attribute";
            }
            if (para.Equals("")) return "Warning:(Not Set)";
            if (globalConst.CurSite.FormDataXML.SelectSingleNode("/formdata/table[@id='" + para.Split('.')[0] + "']/row[@id='" + para.Split('.')[1] + "']") == null)
            {
                return "Warning:(Table or Row removed)" + para;
            }
            return para;
        }
        public static string getFormDataParaName(IHTMLElement ele)
        {
            string para = ele.getAttribute("tag", 0) == null ? null : ele.getAttribute("tag", 0).ToString();
            if (para.Equals("")) return "";
            try
            {
                para = str.GetSplitValue(para, 1);
            }
            catch
            {
                return "Error:Wrong tag attribute";
        ...
        public static void setFormDataParaName(IHTMLElement ele,string paraname)
        {
            string para = ele.getAttribute("tag", 0) == null ? null : ele.getAttribute("tag", 0).ToString();
            try
            {
                para=str.SetSplitValue(para, 2, 1, paraname);
    ...
    public class TextBox
    {
        ...
        public static PropertyBag Bag()
        {
            ...
            bag.Properties.Add(new PropertySpec(res.form.GetString("String99"), typeof(string), curcate, res.form.GetString("String100"), func.getFormDataBindStr(curEle), typeof(FormDataEditor), typeof(FormDataEditorConverter)));
            bag.Properties.Add(new PropertySpec(res.form.GetString("String103"), typeof(string), curcate, res.form.GetString("String104"), func.getFormDataParaName(curEle)));
            ...
            bag.Properties.Add(new PropertySpec(res.form.GetString("String53"), typeof(string), curcate, res.form.GetString("String54"), func.getRule(curEle), typeof(SiteMatrix.classes.TextEditor), typeof(SiteMatrix.classes.TextEditorConverter)));
            return bag;
        }
        private static void GetValue(object sender, PropertySpecEventArgs e)
        {
            string pName = e.Property.Name;
            if (pName.Equals(res.form.GetString("String99")))
            {
                e.Value = func.getFormDataBindStr(curEle);
                return;
            }
            if (pName.Equals(res.form.GetString("String103")))
            {
                e.Value = func.getFormDataParaName(curEle);
                return;
            }
        ...
        private static void SetValue(object sender, PropertySpecEventArgs e)
        {
            ...
            if (pName.Equals(res.form.GetString("String103")))
            {
                func.setFormDataParaName(curEle, pValue);
                return;
            }
            if (pName.Equals(res.form.GetString("String51")))
            {
    ...
    public class Flow
    {
        ...
        public static PropertyBag Bag()
        {
            ...
            string flowtable = str.GetSplitValue(para, 2);
            bag.Properties.Add(new PropertySpec("Append SQL", typeof(string), curcate, "Execute this SQL when the operation finished,can use @session[] @request[] @requestForm[] @siteid@,Multiple sqls split with #", sqlexec));
            bag.Properties.Add(new PropertySpec("Redirect URL", typeof(string), curcate, "Redirect this URL when the operation finished,can use @session[] @request[] @requestForm[] @siteid@", gourl));
            bag.Properties.Add(new PropertySpec(res.form.GetString("String109"), typeof(string), curcate, res.form.GetString("String110"), flowtable, typeof(TableTagEditor), typeof(TableTagEditorConverter)));

            int stattype = 0;
            int.TryParse(str.GetSplitValue(para, 3),out stattype);
            string flowdatasource = str.GetSplitValue(para, 4);
            bag.Properties.Add(new PropertySpec(res.form.GetString("String137"), typeof(string), curcate, res.form.GetString("String141"), (stattype == 0 ? res.form.GetString("String138") : (stattype == 1 ? res.form.GetString("String139") : res.form.GetString("String140"))), typeof(System.Drawing.Design.UITypeEditor), typeof(FormFlowStatType)));
            GetControlData.ControlName = "flow";
            bag.Properties.Add(new PropertySpec(res.form.GetString("String142"), typeof(string), curcate, res.form.GetString("String143"), flowdatasource, typeof(DataSourceEditor), typeof(DataSourceEditorConverter)));

            bag.Properties.Add(new PropertySpec(res.form.GetString("String144"), typeof(string), curcate, res.form.GetString("String145"), str.GetSplitValue(para, 5)));
            bag.Properties.Add(new PropertySpec(res.form.GetString("String146"), typeof(string), curcate, res.form.GetString("String147"), str.GetSplitValue(para, 6)));
        ...
        private static void GetValue(object sender, PropertySpecEventArgs e)
        {
            ...
            if (pName.Equals(res.form.GetString("String109")))
            {
                string para = curEle.getAttribute("tag", 0) == null ? null : curEle.getAttribute("tag", 0).ToString();
                e.Value = str.GetSplitValue(para, 2);
                return;
            }
            ...
            if (pName.Equals(res.form.GetString("String137")))
            {
                string para = curEle.getAttribute("tag", 0) == null ? null : curEle.getAttribute("tag", 0).ToString();
                int stattype = 0;
                int.TryParse(str.GetSplitValue(para, 3), out stattype);
                e.Value = (stattype == 0 ? res.form.GetString("String138") : (stattype == 1 ? res.form.GetString("String139") : res.form.GetString("String140")));
                return;
            }
            if (pName.Equals(res.form.GetString("String142")))
            {
                string para = curEle.getAttribute("tag", 0) == null ? null : curEle.getAttribute("tag", 0).ToString();
                e.Value = str.GetSplitValue(para, 4);
                return;
            }
            if (pName.Equals(res.form.GetString("String144")))
            {
                string para = curEle.getAttribute("tag", 0) == null ? null : curEle.getAttribute("tag", 0).ToString();
                e.Value = str.GetSplitValue(para, 5);
                return;
            }
            if (pName.Equals(res.form.GetString("String146")))
            {
                string para = curEle.getAttribute("tag", 0) == null ? null : curEle.getAttribute("tag", 0).ToString();
                e.Value = str.GetSplitValue(para,6);
                return;
            }
        }
        private static void SetValue(object sender, PropertySpecEventArgs e)
        {
            ...
            {
                string para = curEle.getAttribute("tag", 0) == null ? null : curEle.getAttribute("tag", 0).ToString();
                curEle.setAttribute("tag", str.SetSplitValue(para, 7, 2, pValue), 0);
                return;
            }
            if (pName.Equals("Append SQL"))
            {
                string para = curEle.getAttribute("tag", 0) == null ? null : curEle.getAttribute("tag", 0).ToString();
                curEle.setAttribute("tag", str.SetSplitValue(para,7, 0, pValue), 0);
                return;
            }
            if (pName.Equals("Redirect URL"))
            {
                string para = curEle.getAttribute("tag", 0) == null ? null : curEle.getAttribute("tag", 0).ToString();
                curEle.setAttribute("tag", str.SetSplitValue(para, 7, 1, pValue), 0);
                return;
            }
            if (pName.Equals(res.form.GetString("String142")))
            {
                string para = curEle.getAttribute("tag", 0) == null ? null : curEle.getAttribute("tag", 0).ToString();
                curEle.setAttribute("tag", str.SetSplitValue(para,7, 4, pValue), 0);
                return;
            }
            if (pName.Equals(res.form.GetString("String137")))
            {
                string para = curEle.getAttribute("tag", 0) == null ? null : curEle.getAttribute("tag", 0).ToString();
                int stattype=0;
                stattype=(pValue.Equals(res.form.GetString("String138"))?0:(pValue.Equals(res.form.GetString("String139"))?1:2));
                curEle.setAttribute("tag", str.SetSplitValue(para, 7, 3, stattype.ToString()), 0);
                return;
            }
            if (pName.Equals(res.form.GetString("String144")))
            {
                string para = curEle.getAttribute("tag", 0) == null ? null : curEle.getAttribute("tag", 0).ToString();
                curEle.setAttribute("tag", str.SetSplitValue(para, 7, 5, pValue), 0);
                return;
            }
            if (pName.Equals(res.form.GetString("String146")))
            {
                string para = curEle.getAttribute("tag", 0) == null ? null : curEle.getAttribute("tag", 0).ToString();
                curEle.setAttribute("tag", str.SetSplitValue(para, 7, 6, pValue), 0);
                return;
            }
        }
    }
    ...
    public class FlowExt1
    {
        ...
        public static PropertyBag Bag()
        {
            ...
            bag.Properties.Add(new PropertySpec(res.form.GetString("String109"), typeof(string), curcate, res.form.GetString("String110"), flowtable));
            return bag;
        }
        private static void GetValue(object sender, PropertySpecEventArgs e)
        {
        ...
        private static void SetValue(object sender, PropertySpecEventArgs e)
        {
            ...
            {
                string para = curEle.getAttribute("tag", 0) == null ? null : curEle.getAttribute("tag", 0).ToString();
                curEle.setAttribute("tag", str.SetSplitValue(para, 3, 2, pValue), 0);
                return;
            }
            if (pName.Equals("Append SQL"))
            {
                string para = curEle.getAttribute("tag", 0) == null ? null : curEle.getAttribute("tag", 0).ToString();
                curEle.setAttribute("tag", str.SetSplitValue(para, 3, 0, pValue), 0);
                return;
            }
            if (pName.Equals("Redirect URL"))
            {
                string para = curEle.getAttribute("tag", 0) == null ? null : curEle.getAttribute("tag", 0).ToString();
                curEle.setAttribute("tag", str.SetSplitValue(para, 3, 1, pValue), 0);
                return;
            }
        }
    }
    ...
    public class Select
    {
        ...
        public static PropertyBag Bag()
        {
            ...
            bag.Properties.Add(new PropertySpec(res.form.GetString("String51"), typeof(string), curcate, res.form.GetString("String52"), (eletype == 0 ? res.form.GetString("String48") : (eletype == 1 ? res.form.GetString("String49") : res.form.GetString("String50"))), typeof(System.Drawing.Design.UITypeEditor), typeof(FormTextBoxType)));
            bag.Properties.Add(new PropertySpec(res.form.GetString("String53"), typeof(string), curcate, res.form.GetString("String54"), func.getRule(curEle), typeof(SiteMatrix.classes.TextEditor), typeof(SiteMatrix.classes.TextEditorConverter)));
            bag.Properties.Add(new PropertySpec(res.form.GetString("String60"), typeof(string), curcate, res.form.GetString("String61"), "(Collection)", typeof(SiteMatrix.classes.OptionEditor), typeof(SiteMatrix.classes.OptionEditorConverter)));
            return bag;
        }
        private static void GetValue(object sender, PropertySpecEventArgs e)
        {
    ...
    public class DateAll
    {
        ...
        public static PropertyBag Bag()
        {
            ...
            bag.SetValue += new PropertySpecEventHandler(SetValue);
            string curcate = res.form.GetString("String47");
            bag.Properties.Add(new PropertySpec(res.form.GetString("String69"), typeof(string), curcate, res.form.GetString("String70"), func.getRule(curEle), typeof(SiteMatrix.classes.TextEditor), typeof(SiteMatrix.classes.TextEditorConverter)));
            return bag;
        }
        private static void GetValue(object sender, PropertySpecEventArgs e)
        {
