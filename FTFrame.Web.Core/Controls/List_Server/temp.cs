...
namespace FT.List
{
	public class ftdpcontroltemp
	{
		...
		{
			public static string ChaXun = "Search";
			public static string ZiDingYi = "Custom";
			public static string GaoJi = "Advance";
			public static string LieDingYi = "Column Custom";
			public static string ShuaXin = "Refresh";
		...
		public static string ListTitleMSelect__LayUI_JS(string p0)
		{
			return ("     function listtitlemselect_" + p0 + "(s1,s2) { return '<div class=\"layui-unselect layui-form-checkbox\" name=\"dl_allselect\"  lay-skin=\"primary\" onclick=\"$(this).toggleClass(&apos;layui-form-checked&apos;);dl_SelectAll(this,\\''+s1+'\\',\\''+s2+'\\')\"><i class=\"layui-icon layui-icon-ok\"></i></div>' }  ").Trim();
		}
		...
		public static string SearchText_LayUI(string p0, string p1, string p2, string p3)
		{
			return ("  <input type=\"text\" " + setStyle("csslistsearchtext") + " lay-verify=\"title\" class=\"layui-input\"  id=\"scht_" + p0 + "\" onKeyDown=\"if(event.keyCode==13){dl_search('" + p1 + "')}\"/> <input type=\"hidden\" id=\"schtc_" + p2 + "\" value=\"" + p3 + "\">  ").Trim();
		}
		public static string SearchTextTip_LayUI(string p0, string p1, string p2, string p3, string p4)
		{
			return ("  <input type=\"text\" " + setStyle("csslistsearchtext") + " lay-verify=\"title\" placeholder=\"" + p4 + "\" class=\"layui-input\"  id=\"scht_" + p0 + "\" onKeyDown=\"if(event.keyCode==13){dl_search('" + p1 + "')}\"/> <input type=\"hidden\" id=\"schtc_" + p2 + "\" value=\"" + p3 + "\">  ").Trim();
		}
		...
		public static string ListTd0_JS_Check_Inner_LayUI(string p0, string p1)
		{
			return ("  function listtd0inner_" + p0 + "(id) {   return '<div class=\"layui-unselect layui-form-checkbox listckbox\" layid=\"'+id+'\" lay-skin=\"primary\" onclick=\"$(this).toggleClass(&apos;layui-form-checked&apos;);" + p1 + "\"><i class=\"layui-icon layui-icon-ok\"></i></div>'; }  ").Trim();
		}
		...
		public static string ListTd0_JS_Radio_Inner_LayUI(string p0)
		{
			return ("  function listtd0inner_" + p0 + "(id) {   return '<div class=\"layui-unselect layui-form-radio layui-form-radioed\"  layid=\"'+id+'\"><i class=\"layui-anim layui-icon layui-anim-scaleSpring\"></i></div>'; }  ").Trim();
		}
		...
		public static string ListTd0_JS_Check_LayUI(string p0, string p1)
		{
			return ("  function listtd0_" + p0 + "(id) {   return '<td " + setStyle("cssselecttd") + " width=14px align=center><div class=\"layui-unselect layui-form-checkbox listckbox\"  layid=\"'+id+'\"  lay-skin=\"primary\" onclick=\"$(this).toggleClass(&apos;layui-form-checked&apos;);" + p1 + "\"><i class=\"layui-icon layui-icon-ok\"></i></div></td>'; }  ").Trim();
		}
		...
		public static string ListTd0_JS_Radio_LayUI(string p0)
		{
			return ("  function listtd0_" + p0 + "(id) {   return '<td " + setStyle("cssselecttd") + " width=14px align=center><div class=\"layui-unselect layui-form-radio layui-form-radioed\" layid=\"'+id+'\"><i class=\"layui-anim layui-icon layui-anim-scaleSpring\"></i></div></td>'; }  ").Trim();
		}
		...
		public static string TextLinkDemoStyle2_LayUI(string p0, string p1, string p2)
		{
			return (" <button class='layui-btn' type='button' id=\"" + p0 + "\" " + p1 + ">" + p2 + "</button> ").Trim();
		}
		public static string SeachDiv(string s, int marginLeft)
		{
			return "<div style=\"float:right; margin-left: " + marginLeft + "px\">" + s + "</div>";
		}
